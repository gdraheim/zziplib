...
static int
zzip_inflate_init(ZZIP_FILE*, struct zzip_dir_hdr*);
...
static zzip_size_t
zzip_pread_fallback(ZZIP_FILE* file, void* ptr, zzip_size_t size, zzip_off_t offset)
{
 ...
 */
ZZIP_FILE*
zzip_open_ext_io(zzip_char_t* filename, int o_flags, int o_modes, zzip_strings_t* ext,
                 zzip_plugin_io_t io)
{
 ...
 */
ZZIP_FILE*
zzip_open_shared_io(ZZIP_FILE* stream, zzip_char_t* filename, int o_flags, int o_modes,

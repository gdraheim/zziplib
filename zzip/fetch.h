...
#define zzip_disk_trailer_to_comment(__p) ((char*) ((char*) (__p) + zzip_disk_trailer_headerlength))
...
#define zzip_disk64_trailer_skipto_end(__p) ((void*) ((char*) (__p) + zzip_disk64_sizeto_end(__p)))
